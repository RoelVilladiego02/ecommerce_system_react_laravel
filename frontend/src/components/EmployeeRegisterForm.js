                ...
                <div className="col-md-8 col-lg-6">
                    <div className="card border-primary shadow-lg">
                        <div className="card-header bg-primary text-white">
                            <h2 className="text-center mb-0">Employee Registration</h2>
                        </div>
                        <div className="card-body p-4">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="text" className="form-control" id="adminKey" 
                                        placeholder="Enter admin key" value={adminKey} onChange={(e) => setAdminKey(e.target.value)} required />
                                </div>
